...
if ( isset($_GET['activated']) ){
    ...
    $init_pages = array(
        'pages/posts-pachongplay.php' => array( '站外搜索播放', 'cinemaplay' ),
        'pages/posts-showplay.php' => array( '本站搜索播放', 'showplay' ),
        'pages/posts-search.php' => array( '搜索结果', 'search' ),
        'pages/posts-xiaoplay.php' => array( '搞笑播放', 'xiaoplay' ),
        'pages/posts-film.php' => array( '看电影', 'film' ),
        'pages/posts-tvshow.php'  => array( '追热剧', 'tvshow' ),
        'pages/posts-va.php' => array( '综艺', 'va' ),
        'pages/posts-dongman.php' => array( '动漫', 'dongman' ),
        'pages/posts-bdpan.php' => array( '百度网盘搜索', 'baiduwp' ),
        'pages/posts-bdpango.php' => array( '百度网盘资源查看', 'bdwpgo' ),
        'pages/posts-cili.php' => array( '磁力种子搜索', 'cili' ),
        'pages/posts-xiao.php'	=> array( '不开心', 'xiao' ),
        'pages/posts-play.php'	=> array( '播放页', 'play' ),
        'pages/posts-tv.php'	=> array( '电视直播', 'tv' ),
        'pages/posts-music.php'	=> array( '影院mv', 'mv' ),
    );

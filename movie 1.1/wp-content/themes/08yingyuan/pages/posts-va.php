...
if(!$_GET['cat']){
	...
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=all&pageno='.$_GET[pageno] ;//默认输出近期最热列表
}else{
	if($_GET['cat']=='101'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=101&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='102'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=102&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='103'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=103&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='104'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=104&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='105'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=105&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='106'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=106&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='107'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=107&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='108'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=108&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='110'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=110&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='111'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=111&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='112'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=112&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='113'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=113&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='116'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=116&pageno='.$_GET[pageno] ;
	}elseif($_GET['cat']=='119'){
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=119&pageno='.$_GET[pageno] ;
	}else{
	$queryURL = 'http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=all&pageno='.$_GET[pageno] ;
	$fenlei = 'all';//默认输出近期最热列表
	}
	$fenlei = $_GET['cat'];
}
...
<a class="js-tongjip" id="no101" href="?cat=101" target="_self">选秀</a>
<a class="js-tongjip" id="no102" href="?cat=102" target="_self">八卦</a>
<a class="js-tongjip" id="no103" href="?cat=103" target="_self">访谈</a>
<a class="js-tongjip" id="no104" href="?cat=104" target="_self">情感</a>
<a class="js-tongjip" id="no105" href="?cat=105" target="_self">生活</a>
<a class="js-tongjip" id="no106" href="?cat=106" target="_self">晚会</a>
<a class="js-tongjip" id="no107" href="?cat=107" target="_self">搞笑</a>
<a class="js-tongjip" id="no108" href="?cat=108" target="_self">音乐</a>
<a class="js-tongjip" id="no110" href="?cat=110" target="_self">游戏</a>
<a class="js-tongjip" id="no111" href="?cat=111" target="_self">少儿</a>
<a class="js-tongjip" id="no112" href="?cat=112" target="_self">体育</a>
<a class="js-tongjip" id="no113" href="?cat=113" target="_self">记实</a>
<a class="js-tongjip" id="no116" href="?cat=116" target="_self">歌舞</a>
<a class="js-tongjip" id="no119" href="?cat=119" target="_self">报道</a>
</dd>
</dl>
</div>
</div>
...
$str = str_replace("/va/","/play?make=zongyi&id=",$str);
$str = str_replace("http://www.360kan.com/zongyi/list.php?act=all&area=all&cat=".$fenlei."&pageno=","?cat=".$fenlei."&pageno=",$str);
echo $str;
?></a>
</div>
</div></div>

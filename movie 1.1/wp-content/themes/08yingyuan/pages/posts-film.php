...
if(!$_GET['cat']){
	...
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=all&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];//默认输出近期最热列表
}else{
	if($_GET['cat']=='103'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=103&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='100'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=100&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='106'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=106&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='102'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=102&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='104'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=104&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='112'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=112&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='105'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=105&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='113'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=113&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='108'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=108&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='115'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=115&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='107'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=107&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}elseif($_GET['cat']=='123'){
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=123&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	}else{
	$queryURL = 'http://www.360kan.com/dianying/list.php?cat=all&year=all&area=all&act=all&rank=rankhot&pageno='.$_GET[pageno];
	$fenlei = 'all';//默认输出近期最热列表
	}
	$fenlei = $_GET['cat'];
}
...
<a class="js-tongjip" id="no103" href="?cat=103" target="_self">喜剧</a>
<a class="js-tongjip" id="no100" href="?cat=100" target="_self">爱情</a>
<a class="js-tongjip" id="no106" href="?cat=106" target="_self">动作</a>
<a class="js-tongjip" id="no102" href="?cat=102" target="_self">恐怖</a>
<a class="js-tongjip" id="no104" href="?cat=104" target="_self">科幻</a>
<a class="js-tongjip" id="no112" href="?cat=112" target="_self">剧情</a>
<a class="js-tongjip" id="no105" href="?cat=105" target="_self">犯罪</a>
<a class="js-tongjip" id="no113" href="?cat=113" target="_self">奇幻</a>
<a class="js-tongjip" id="no108" href="?cat=108" target="_self">战争</a>
<a class="js-tongjip" id="no115" href="?cat=115" target="_self">悬疑</a>
<a class="js-tongjip" id="no107" href="?cat=107" target="_self">动画</a>
<a class="js-tongjip" id="no123" href="?cat=123" target="_self">惊悚</a>
</dd>
</dl>
</div>
</div>
...
$str = str_replace("/m/","/play?make=dianying&id=",$str);
$str = str_replace("http://www.360kan.com/dianying/list.php?cat=".$fenlei."&year=all&area=all&act=all&rank=rankhot&pageno=","?cat=".$fenlei."&pageno=",$str);
echo $str;
?>
</a>
</div>

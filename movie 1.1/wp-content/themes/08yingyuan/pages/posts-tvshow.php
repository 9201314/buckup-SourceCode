...
if(!$_GET['cat']){
	...
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=all&pageno='.$_GET[pageno];//默认输出近期最热列表
}else{
	if($_GET['cat']=='101'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=101&pageno='.$_GET[pageno];//言情
	}elseif($_GET['cat']=='105'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=105&pageno='.$_GET[pageno];//伦理
	}elseif($_GET['cat']=='109'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=109&pageno='.$_GET[pageno];//喜剧
	}elseif($_GET['cat']=='108'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=108&pageno='.$_GET[pageno];//悬疑
	}elseif($_GET['cat']=='111'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=111&pageno='.$_GET[pageno];//都市
	}elseif($_GET['cat']=='100'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=100&pageno='.$_GET[pageno];//偶像
	}elseif($_GET['cat']=='104'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=104&pageno='.$_GET[pageno];//古装
	}elseif($_GET['cat']=='103'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=103&pageno='.$_GET[pageno];//警匪
	}elseif($_GET['cat']=='112'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=112&pageno='.$_GET[pageno];//历史
	}elseif($_GET['cat']=='106'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=106&pageno='.$_GET[pageno];//武侠
	}elseif($_GET['cat']=='113'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=113&pageno='.$_GET[pageno];//科幻
	}elseif($_GET['cat']=='117'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=117&pageno='.$_GET[pageno];//神话
	}elseif($_GET['cat']=='115'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=115&pageno='.$_GET[pageno];//动作
	}elseif($_GET['cat']=='114'){
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=114&pageno='.$_GET[pageno];//情景
	}else{
	$queryURL = 'http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=all&pageno='.$_GET[pageno];//默认输出近期最热列表
	$fenlei = 'all';//默认输出近期最热列表
	}
...
<a class="js-tongjip" id="no101" href="?cat=101" target="_self">言情</a>
<a class="js-tongjip" id="no105" href="?cat=105" target="_self">伦理</a>
<a class="js-tongjip" id="no109" href="?cat=109" target="_self">喜剧</a>
<a class="js-tongjip" id="no108" href="?cat=108" target="_self">悬疑</a>
<a class="js-tongjip" id="no111" href="?cat=111" target="_self">都市</a>
<a class="js-tongjip" id="no100" href="?cat=100" target="_self">偶像</a>
<a class="js-tongjip" id="no104" href="?cat=104" target="_self">古装</a>
<a class="js-tongjip" id="no103" href="?cat=103" target="_self">警匪</a>
<a class="js-tongjip" id="no112" href="?cat=112" target="_self">历史</a>
<a class="js-tongjip" id="no106" href="?cat=106" target="_self">武侠</a>
<a class="js-tongjip" id="no113" href="?cat=113" target="_self">科幻</a>
<a class="js-tongjip" id="no117" href="?cat=117" target="_self">神话</a>
<a class="js-tongjip" id="no115" href="?cat=115" target="_self">动作</a>
<a class="js-tongjip" id="no114" href="?cat=114" target="_self">情景</a>
</dd>
</dl>
</div>
</div>
...
$str = str_replace("/tv/","/play?make=dianshiju&id=",$str);
$str = str_replace("http://www.360kan.com/dianshi/list?year=all&area=all&act=all&cat=".$fenlei."&pageno=","?cat=".$fenlei."&pageno=",$str);
echo $str;
?></a>
</div>
</div></div>

...
class ConfigureController extends Controller{
	...
	public function UpdateAction(){
		...
		'siteinfo' => isset($_POST['siteinfo']) ? $_POST['siteinfo'] : '一个二次元图片的领域-认真你就输啦 (・ω・)ノ- ( ゜- ゜)つロ',	//站点副标题
		'keywords' => isset($_POST['keywords']) ? $_POST['keywords'] : '二次元图片,新浪图床',	//站点关键字
		'description' => isset($_POST['description']) ? $_POST['description'] : '你的二次元图片分享基地，一个二次元图片的领域-认真你就输啦 (・ω・)ノ- ( ゜- ゜)つロ',	//站点描述

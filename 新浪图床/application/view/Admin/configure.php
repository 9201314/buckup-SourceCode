	...
	<form class="layui-form">
		<table class="layui-table mag0">
		    ...
		    <tbody>
		    	...
		    	<tr>
		    		<td>缩略图级别</td>
		    		<td><input type="text" class="layui-input level" placeholder="请输入缩略图级别"></td>
		    		<td pc>探索界面缩略图级别(0-7)</td>
		    	</tr>
		    	<tr>
		    		<td>163邮箱账号</td>
		    		<td><input type="text" class="layui-input user" lay-verify="required" placeholder="请输入163邮箱账号"></td>
		    	...
		    	<tr>
		    		<td>验证码有效时间</td>
		    		<td><input type="text" class="layui-input etime" placeholder="请输入验证码有效时间"></td>

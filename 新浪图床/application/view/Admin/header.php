  ...
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item">
        <a href="javascript:;">
          <img src="<?php $src = is_file('upload/uid_'.$_SESSION['authen']['uid'] . '.png') ?  PATH_URL .'upload/uid_'.$_SESSION['authen']['uid'] . '.png' : PATH_URL.'application/view/Admin/images/author.jpg';echo $src;?>" class="layui-nav-img">

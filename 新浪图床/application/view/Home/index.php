      ...
      <div class="site-wrapper-inner"> 
        <div class="cover-container">
            ...
            <div class="inner">
              ...
              <nav>
                <ul class="nav masthead-nav">
					...
					<!-- <li><a href="javascript:volid(0)" id="upload"> <span class="glyphicon glyphicon-cloud-upload"></span> 上传</a></li> -->
				<?php if($explore=='y'):?>
          ...
          <div class="inner cover">
            ...
            <p class="lead">高速稳定的图片上传和分享服务, 全球CDN加速, 最大10 MB/张 , 无限制的图片外链, BBCode代码, HTML代码, 缩略图, 专属的个人主页, 你要的一切，这里都有</p>
			<p class="lead"><?php echo $prompt;?>不和谐上传删图&amp;账号，且行且珍惜。</p>
            <p class="lead">
              <a href="javascript:volid(0)" id="upload" style="background: transparent;color: #FFF;" class="btn btn-lg btn-default">开始上传</a>
            </p>

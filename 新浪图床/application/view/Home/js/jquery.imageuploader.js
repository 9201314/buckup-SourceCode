    ...
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            options = $.extend({
                ...
                ajaxUrl: 'Home/Index/UploadAction/',
                testMode: false
            }, options);
            ...
            var dom = {
                uploaderBox: $(this),
                submitButton: $('<button class="js-uploader__submit-button uploader__submit-button uploader__hide" id="disabled">' +
            ...
            function addItem (file) {
                ...
                state.listIndex++;
                file.size++;
                if (file.size > 10485760) {alert('上传的总文件大小超过限制！');return}
                ...
                // validate the file
                if (options.fileTypeWhiteList.indexOf(getExtension(file.name).toLowerCase()) !== -1 && fileSize < 10485760) {

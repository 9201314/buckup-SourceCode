...
<head>
	...
	<title>Joeleo直播</title>
    <meta name="renderer" content="webkit">
    <meta name="viewport" content="width=device-width,initial-scale=1.0,user-scalable=no,minimal-ui">
    <meta name="keywords" content="直播,电视直播,网络电视,乐视网络电视,卫星电视" />
    <meta name="description" content="Joeleo直播网,提供网络电视直播,湖南卫视,浙江卫视,东方卫视,北京卫视,河南卫视,江苏卫视,上海第一财经,体育频道,卫视节目表,免费视频直播,本港台在线观看高清回放。" />
...
<section class="header">
	<header class="aui-bar aui-bar-nav" id="aui-header">
		...
		<div class="aui-title">Joeleo直播</div>
...
<!-- 信息条  -->
    <div class="aui-tips" id="tips-1">
	    ...
	    <div class="aui-tips-title">正在播放：山东卫视&nbsp;&nbsp;高清</div>
	    <i class="aui-iconfont aui-icon-close" tapmode onclick="closeTips()"></i>
	</div>
<!-- 播放器  -->	
   <section class="video-box">
    <video width="100%" height="230" controls="controls" autoplay="autoplay" src="http://ivi.bupt.edu.cn/hls/sdhd.m3u8"></video>
   </section>
				...
				<div id="tabs-container" class="swiper-container">
					<div class="swiper-wrapper">
				        <div class="swiper-slide">
							<div class="numList">
								<ul>
								 <li class="active"><a href="http://ivi.bupt.edu.cn/hls/sdhd.m3u8" rel="nofollow">高清<i class="iNewIcon"></i></a></li>
								</ul>
							</div>
						</div>
					</div> 

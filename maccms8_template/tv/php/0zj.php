...
<!-- 信息条  -->
    <div class="aui-tips" id="tips-1">
	    ...
	    <div class="aui-tips-title">正在播放：浙江卫视&nbsp;&nbsp;高清</div>
	    <i class="aui-iconfont aui-icon-close" tapmode onclick="closeTips()"></i>
	</div>
<!-- 播放器  -->	
   <section class="video-box">
    <video width="100%" height="230" controls="controls" autoplay="autoplay" src="http://ivi.bupt.edu.cn/hls/zjhd.m3u8"></video>
   </section>
				...
				<div id="tabs-container" class="swiper-container">
					<div class="swiper-wrapper">
				        <div class="swiper-slide">
							<div class="numList">
								<ul>
								 <li class="active"><a href="http://ivi.bupt.edu.cn/hls/zjhd.m3u8" rel="nofollow">高清<i class="iNewIcon"></i></a></li>
								</ul>
							</div>
						</div>
					</div> 

      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="Hao_db" class="input"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="xw_" class="input"></td>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="乐道选号网 - 我们一直用心服务!" class="input"></td>
          ...
          <tr>
            <td class="tar">关键词：</td>
            <td><input type="text" name="keywords" value="ledao,LedaoCMS,乐道选号网,乐道选号网管理系统,乐道社区,吾爱乐道,乐道网" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="乐道选号网是乐道-奋斗之路工作室发布的一款用于选号网快速搭建的内容管理系统"></td>
